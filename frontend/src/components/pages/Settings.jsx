...
import useChangeCredential from '../../hooks/useChangeCredential';
...
const Settings = () => {
  ...
  const { changeCredential, isLoading, errMsg, exitMsg, setExitMsg } = useChangeCredential();
      ...
      <div className='bg-black w-full h-full text-white'>
        <div className='flex flex-col gap-7 my-10 mx-8'>
          ...
          <p className='text-sm font-extralight'>
            This information will be displayed public to be careful what you share
          </p>
          ...
          <div className={`flex flex-col sm:flex-row pl-10 ${errMsg || exitMsg ? 'justify-between' : 'justify-end'}`}>
            {exitMsg ? (
            ...
            <div className='flex sm:justify-end gap-10 mt-5 sm:mt-0 items-center sm:mr-20'>
              ...
              <button
                disabled={isLoading || exitMsg}
                className={`${
                  isLoading ? 'flex justify-center items-center gap-1 px-5' : 'px-8'
